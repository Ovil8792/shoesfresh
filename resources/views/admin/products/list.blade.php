                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0">{{ number_format($avgPrice ?? 0, 0, ',', '.') }} VND</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <form method="GET" class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.product') }}" class="btn btn-outline-secondary"><i class="bi bi-x-circle"></i></a>
                    </form>
                </div>
            </div>
        </div>
                ...
                <table class="table table-hover mb-0" id="roomsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td class="align-middle text-muted">
                                <span class="mb-0 fw-semibol">{{ $item->category->name ?? 'N/A' }}</span>
                           </td>
                           <td class="align-middle text-muted">
                                <img width="60px" height="60px" src="{{ $item->image ? asset('storage/' . $item->image) : asset('assets/img/product/p1.jpg') }}" style="object-fit: cover;">
                           </td>
                           <td class="align-middle text-muted">
                           ...
                           <td class="align-middle text-muted">
                            ...
                            <td class="align-middle">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.product.show', $item->id) }}" class="btn btn-sm btn-info" title="Xem chi tiết">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.product.edit', $item->id) }}" class="btn btn-sm btn-warning" title="Sửa">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="{{ route('admin.product.delete', $item->id) }}" class="btn btn-sm btn-danger" title="Xóa" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?')">
